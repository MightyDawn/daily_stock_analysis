...
DSA_SCREENING_SNAPSHOT_FALLBACK_MAX_AGE_HOURS = 24  # 回退缓存最大有效期（小时），防止使用过期数据
...
def _build_screening_runtime_env(config: Config, *, max_results: Optional[int] = None) -> Dict[str, str]:
    ...
    put_default("SNAPSHOT_FALLBACK_MAX_AGE_HOURS", str(DSA_SCREENING_SNAPSHOT_FALLBACK_MAX_AGE_HOURS))
